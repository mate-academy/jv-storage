...
public class StorageImplTest {
    ...
    public void checkSizeIsNonStatic() {
        Storage<Integer, String> firstInstance = new StorageImpl<>(key, value);
        ...
        Storage<Integer, String> secondInstances = new StorageImpl<>(key, value);
    ...
    public void addElementsToStorage() {
        Storage<Integer, String> storage = new StorageImpl<>(key, value);
    ...
    public void getElementWhenKeyIsObject() {
        Storage<Cat, String> storage = new StorageImpl<>(key, value);
        String elementOne = "Element 1";
        String elementTwo = "Element 2";
        String elementTree = "Element 3";
