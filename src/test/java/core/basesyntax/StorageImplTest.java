...
public class StorageImplTest {
    ...
    public void checkSizeIsNonStatic() {
        Storage<Integer, String> firstInstance = new StorageImpl<>(keys, values, size);
        ...
        Storage<Integer, String> secondInstances = new StorageImpl<>(keys, values, size);
    ...
    public void addElementsToStorage() {
        Storage<Integer, String> storage = new StorageImpl<>(keys, values, size);
    ...
    public void getElementWhenKeyIsObject() {
        Storage<Cat, String> storage = new StorageImpl<>(keys, values, size);
        String elementOne = "Element 1";
        String elementTwo = "Element 2";
        String elementTree = "Element 3";
