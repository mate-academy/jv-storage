...
Implement the `StorageImpl` of `key-value` type that is parameterized with two types of data. 
...
If you use arrays for your solution, we assume that the maximum number of elements in our `StorageImpl` is 10.
